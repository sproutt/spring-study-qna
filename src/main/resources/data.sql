...
INSERT INTO USER (id, user_id, password, name, email) VALUES (3, 'asd', '123', '민섭minseob', 'minseob@slipp.net');
INSERT INTO USER (id, user_id, password, name, email) VALUES (4, 'test', '123', '섭섭', '섭minseob@slipp.net');
